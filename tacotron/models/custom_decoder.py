...
class CustomDecoder(decoder.Decoder):
    ...
    def step(self, time, inputs, state, name=None):
        ...
        Enables for dynamic <stop_token> prediction
        Args:
        ...
        """
        with tf.name_scope(name, "CustomDecoderStep", (time, inputs, state)):
            # Call output projection wrapper cell
            (cell_outputs, stop_token), cell_state = self._cell(inputs, state)

            # apply output_layer (if exists)
